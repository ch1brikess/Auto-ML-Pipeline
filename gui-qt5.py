...
class ThemeManager:
    ...
    def create_custom_theme(self, name, colors_dict):
        theme_data = {
            ...
            "button_pressed": colors_dict.get('button_pressed', '#7e57c2'),
...
class MLPipelineGUI(QMainWindow):
    ...
    def create_advanced_tab(self):
        ...
        self.n_jobs_spin.setRange(-1, 15)
    ...
    def create_custom_theme(self):
        from PyQt5.QtWidgets import QDialog, QFormLayout, QColorDialog
